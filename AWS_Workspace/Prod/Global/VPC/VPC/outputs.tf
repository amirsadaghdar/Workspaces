...
# Outputs CryptoCurrency VPC

output "vpc_cryptocurrency_vpc_id" {
  value = module.vpc_cryptocurrency.aws_vpc_id
}

output "vpc_cryptocurrency_subnet1_id" {
  value = module.vpc_cryptocurrency.aws_subnet1_id
}

output "vpc_cryptocurrency_subnet2_id" {
  value = module.vpc_cryptocurrency.aws_subnet2_id
}

output "vpc_cryptocurrency_subnet3_id" {
  value = module.vpc_cryptocurrency.aws_subnet3_id
}

output "vpc_cryptocurrency_subnet4_id" {
  value = module.vpc_cryptocurrency.aws_subnet4_id
}